...
def main():
    ...
    remove_motion_effect(windy)
    remove_motion_effect(nwindy)
    remove_motion_effect(forest)
    ...
    rsquared_df.to_hdf(dir+'Desert_Rsquared_f.h5', key='rsquared_df', mode='w')
    aic_df.to_hdf(dir+'Desert_Aic_f.h5', key='aic_df', mode='w')
